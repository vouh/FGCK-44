        ...
        <div className="relative grid gap-10 py-16 md:grid-cols-4">
          ...
          <div className="md:col-span-1">
            ...
            <div className="mt-6 flex gap-3">
              <a href="https://www.facebook.com/githurai2014"className="flex h-10 w-10 items-center justify-center rounded-lg bg-blue-800/50 text-white transition-all hover:bg-blue-600 hover:scale-110">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
              </a>
              <a href="https://www.youtube.com/@fullgospelchurchesofkenyag599" className="flex h-10 w-10 items-center justify-center rounded-lg bg-red-600/50 text-white transition-all hover:bg-red-600 hover:scale-110">
