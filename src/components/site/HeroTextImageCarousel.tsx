...
export default function HeroTextImageCarousel() {
  ...
  return (
    <div className="relative w-full flex flex-col lg:flex-row items-center justify-between gap-4 lg:gap-12 px-0 md:px-8 max-w-[96rem] xl:max-w-[120rem] mx-auto pt-2 lg:pt-4">
      ...
      <div className="flex flex-col justify-center items-start z-10 w-full max-w-4xl px-2 sm:px-8 lg:pl-24 relative mt-2 lg:mt-0 mb-2 lg:mb-0">
      ...
      <div className="flex items-center justify-center relative w-full max-w-2xl h-[22rem] lg:h-[26rem] mt-2 lg:mt-0">
